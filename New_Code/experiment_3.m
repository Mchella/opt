...
%xlswrite('results\experiment3.xlsx', Result);
minIn=min(Result);
...
for i=1:100
    %hold on
    line([i+20,i+20],[minIn-1000,eRandReturn(i)])
end

line([10,10],[minIn-1000,Result(1)],'Color','red')
...
set(gca,'XTickLabel',{'','\theta_3^{*}','\theta_1','','','','…','','','','','','\theta_{100}'})
set(gca,'color','w')    
%set(gca, 'FontSize', 18);
...
axis([0 120,minIn-1000,max(Result)+1000]);
...
%title('(b)')
    set(gca,'FontSize',19);
    %set(gca,'FontSize',50);
    print fig\experiment_3.eps -depsc2 -r600
