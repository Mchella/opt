function eNumReturn=experiment_8()
clc
clear
...
%xlswrite('results\experiment8.xlsx', eNumReturn);
% subplot(2,3,1)
    plot([0.1:0.1:1],eNumReturn,'ro-')
    set(gcf,'color','w')  
    xlabel('$\alpha$','interpreter','latex')
    %xlabel('$\overline \theta$');
    ylabel('$J(\theta_{\alpha}^*)$','interpreter','latex')
    %ylabel('J(\theta^{*}_{T})')
    set(gca,'FontSize',19);
    %set(gca,'FontSize',20);
    print fig\experiment_8.eps -depsc2 -r600
%    subplot(1,3,2)
%    plot(I)
%    subplot(2,3,3)
%    plot(U)
