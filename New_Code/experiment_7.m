function eNumReturn=experiment__7()
clc
clear
...
%xlswrite('results\experiment7.xlsx', eNumReturn);
% subplot(2,3,1)
    plot([0.05:0.05:0.5],eNumReturn,'ro-')
    set(gcf,'color','w')  
    xlabel('$\delta$','interpreter','latex')
    %xlabel('$\overline \theta$');
    ylabel('$J(\theta_{\delta}^*$)','interpreter','latex')
    %ylabel('J(\theta^{*}_{T})')
    set(gca,'FontSize',19);
    %set(gca,'FontSize',20);
    print fig\experiment_7.eps -depsc2 -r600
%    subplot(1,3,2)
%    plot(I)
%    subplot(2,3,3)
%    plot(U)
