function eNumReturn=experiment_4()
clc
clear
% T=5;%时间
eNumReturn=[];
...
%xlswrite('results\experiment4.xlsx', eNumReturn);
% subplot(2,3,1)
    plot([1:1:10],eNumReturn,'ro-')
    set(gcf,'color','w')  
    xlabel('$T$','interpreter','latex');
    ylabel('$J(\theta^{*}_{T})$','interpreter','latex')
    set(gca,'FontSize',19);
    %set(gca,'FontSize',20);
    print fig\experiment_4.eps -depsc2 -r600
%    subplot(1,3,2)
%    plot(I)
%    subplot(2,3,3)
%    plot(U)
